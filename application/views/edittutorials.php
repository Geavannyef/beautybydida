...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Edit Tutorials Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
		 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form enctype="multipart/form-data" role="form" class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/ContTutorials/editTutorials/<?php echo $data['id_tutorials']?>">
                           <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Video</h3>
                                <textarea name="path" rows="3" class="form-control" placeholder="link video" id="message" required data-validation-required-message="Please enter a message."><?php echo $data['path'];?></textarea>
							</div>
