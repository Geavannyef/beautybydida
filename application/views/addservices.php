...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Tambah Services by Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
		 <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form enctype="multipart/form-data" role="form" class="form-horizontal" method="POST" action="do_add">
                           <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Judul</h3>
                                <textarea name="judul" rows="2" class="form-control" placeholder="Judul beauty hacks " id="message" required data-validation-required-message="Judul beauty hacks"></textarea>
							</div>
                           <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Caption</h3>
                                <textarea name="caption" rows="3" class="form-control" placeholder="Details beauty hacks" id="message" required data-validation-required-message="Judul beauty hacks"></textarea>
							</div>
							<div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Harga</h3>
                                <textarea name="harga" rows="1" class="form-control" placeholder="Details beauty hacks" id="message" required data-validation-required-message="Judul beauty hacks"></textarea>
							</div>
							<div class="form-group col-xs-12 floating-label-form-group controls">
                                <label for="foto" class="form-group col-xs-12 floating-label-form-group controls" style="font-size: 20px">Gambar</label>
                                    <input name="path" type="file" id="foto" required accept="img/*">
							</div>
                            </div>
                            </div>
                            <div class="form-group">
