...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url(). 'index.php/ContTutorials'; ?>"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Tutorials</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Tambah Tutorial by Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
		 <div id="page-wrapper">
                        ...
                        <form enctype="multipart/form-data" role="form" class="form-horizontal" method="POST" action="do_add">
                           <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Video</h3>
                                <textarea name="path" rows="3" class="form-control" placeholder="Link video tutorials dari youtube. Ubah 'watch?v=' menjadi 'embed' seperti ini : https://www.youtube.com/watch?v=5zlDUZlFitQ --->> https://www.youtube.com/embed/5zlDUZlFitQ" id="message" required data-validation-required-message="Masukkan link video tutorials." ></textarea>
