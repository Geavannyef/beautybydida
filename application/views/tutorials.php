...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<?php echo base_url(). 'index.php/ContTutorials'; ?>"><svg class="glyph stroked penci;"><use xlink:href="#stroked-pencil"></use></svg> Tutorials</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Tutorials Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    foreach($data as $row)
                                    {
                                        echo '<tr>
                                        	<td>'. $row['path'] .'</td>
                                          	<td><button style="width:50px">Edit<a href='. base_url()."index.php/ContTutorials/editTutorials/".$row['id_tutorials'].' class="btn btn-warning fa fa-edit" title="Edit"></a></button>
                                          		<button style="width:80px">Hapus<a href='. base_url()."index.php/ContTutorials/hapusTutorials/".$row['id_tutorials'].' class="btn btn-warning fa fa-edit" title="Hapus"></a></button>
											</td>
                                            </tr>';
                                   		}
                                    ?>
