                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">
                            Beauty Hacks by Beauty by Dida
                        </h2>
                                ...
                                <tbody>
                                    ...
                                    foreach($data as $row)
                                    {
                                        echo '<tr>
                                            ...
                                            <td><button>Edit<a href='. base_url()."index.php/ContBeauty/editBeauty/".$row['id_beauty'].' class="btn btn-warning fa fa-edit" title="Edit"></a></button>
                                            	<button>Hapus<a href='. base_url()."index.php/ContBeauty/hapusBeauty/".$row['id_beauty'].' class="btn btn-warning fa fa-edit" title="Hapus"></a></button>
											</td>
                                            </tr>';
