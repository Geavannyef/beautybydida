...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Tambah Beauty Hacks by Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
		 <div id="page-wrapper">
                        ...
                        <form enctype="multipart/form-data" role="form" class="form-horizontal" method="POST" action="do_add">
                           <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Judul</h3>
                                <textarea name="judul" rows="3" class="form-control" placeholder="Judul beauty hacks " id="message" required data-validation-required-message="Judul beauty hacks"></textarea>
							</div>
                           <div class="form-group col-xs-12 floating-label-form-group controls">
                                <h3>Details</h3>
                                <textarea name="details" rows="5" class="form-control" placeholder="Details beauty hacks" id="message" required data-validation-required-message="Judul beauty hacks"></textarea>
							</div>
							<div class="form-group col-xs-12 floating-label-form-group controls">
