...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Services Beauty by Dida</h2>
			</div>
		</div><!--/.row-->
                                ...
                                <tbody>
                                    ...
                                    foreach($data as $row)
                                    {
                                        echo '<tr>
                                            ...
                                            <td><button style="width:60px"> Edit<a href='. base_url()."index.php/ContServices/editServices/".$row['id_services'].' class="btn btn-warning fa fa-edit" title="Edit"></a></button>
                                            	<button>Hapus<a href='. base_url()."index.php/ContServices/hapusServices/".$row['judul'].' class="btn btn-warning fa fa-edit" title="Hapus"></a></button>
